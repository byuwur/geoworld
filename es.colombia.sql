...
-- Tiempo de generación: 10-11-2019 a las 19:19:54
...
INSERT INTO `ciudades` (`IDCIUDAD`, `NOMBRECIUDAD`, `estados_IDESTADO`) VALUES
(1, 'Leticia', 1),
(2, 'Puerto Nariño', 1),
(3, 'Abejorral', 2),
(4, 'Abriaquí', 2),
...
CREATE TABLE `estados` (
  ...
  `NOMBREESTADO` varchar(99) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `ciudades`
  ...
  ADD KEY `fk_ciudades_estados_idx` (`estados_IDESTADO`);
...
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `fk_ciudades_estados` FOREIGN KEY (`estados_IDESTADO`) REFERENCES `estados` (`IDESTADO`) ON DELETE NO ACTION ON UPDATE NO ACTION;
